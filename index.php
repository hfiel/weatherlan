...
<title>WeatherLAN</title>
<meta name="keywords" content="sensor, arduino, temperatura, humedad" />
...
<h3>WeatherLAN: sensor de temperatura y humedad con Arduino</h3>
<div id="faq">
<ol>
<li>Qué es WeatherLAN:</li>
	<ul>
		...
		<li>Utiliza una plataforma HW Arduino junto con 2 sensores de temperatura y 1 de humedad.</li>
		<li>Almacena en una BBDD accesible mediante Web la información recibida del sistema HW.</li>
	</ul>
<li>Autor:</li>
	<ul>
		<li>El proyecto ha sido creado por Héctor Fiel (<a href="http://hfiel.es">http://hfiel.es</a>) durante su Beca de Investigación en la <a href="http://www.juntadeandalucia.es/cultura/web">Consejería de Cultura - Junta de Andalucía</a></li>
	</ul>
<li>Documentación:</li>
	<ul>
		<li>Memoria del proyecto: <a href="weatherlan_memoria.pdf">weatherlan_memoria.pdf</a>. <br/> En la documentación del proyecto en PDF se incluye toda la información generada en el mismo. Si tu interés es simplemente construir el sensor, uno de los anexos finales contiene toda la información necesaria. El resto del documento detalla el proceso de investigación del mismo, y probablemente no te resulte de utilidad.</li>
	</ul>

<li>Descarga:</li>
	<ul>
		<li>Versión 1: <a href="weatherlan_v1.zip">weatherlan_v1.zip</a>. El fichero ZIP contiene todos los códigos y ficheros necesarios para construir e implantar el sensor, así como el servidor web. Se incluyen igualmente los ficheros para fabricar la placa PCB, así como los esquemas eléctricos.</li>
	</ul>
<li>Licencias:</li>
	<ul>
